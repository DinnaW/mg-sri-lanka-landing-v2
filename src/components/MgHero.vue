...
/* =========================================================
   HERO SLIDES
   Make sure these files exist inside public/videos.
========================================================= */
const slides = [
  {
    id: "s5-ev",
    ...
    video: asset("videos/mg-s5-ev.mp4"),
  ...
  },
  {
    ...
    video: asset("videos/mg4-electric.mp4"),
  ...
  },
  {
    ...
    video: asset("videos/mg-zs-ev.mp4"),
...
const VIDEO_FALLBACK_DELAY = 2500;
...
const handleVideoError = (index, event) => {
  console.error(
    `Hero video failed to load: ${slides[index].video}`,
    event
  );
...
const startVideoFallback = (index) => {
  clearFallbackTimer();
...
/* =========================================================
   NAVIGATION
========================================================= */
const goToSlide = (index, fromAuto = false) => {
  if (
    index < 0 ||
    index >= slides.length ||
    index === activeIndex.value
  ...
  videoReady.value[index] = false;

  startVideoFallback(index);
  scheduleAutoAdvance();
};
    ...
    <div class="mg-hero__videos">
      ...
      >
        ...
        >
          <video
            :src="slide.video"
            :aria-label="`${slide.model} cinematic background`"
            muted
            autoplay
            loop
            playsinline
        ...
        >
          ...
          >
            ...
            <div class="vehicle-card__meta">
              ...
              <strong>{{ activeSlide.model }}</strong>
            </div>
          </a>
          ...
          <div class="vehicle-card__bottom">
            ...
            >
              <span class="vehicle-card__icon">
                ...
                >
                  <path
                    d="m32 3.25c-15.85 0-28.75 12.9-28.75 28.75s12.9 28.75 28.75 28.75 28.75-12.9 28.75-28.75-12.9-28.75-28.75-28.75zm-5.19 49.57c-8.93-2.22-15.67-10.06-16.23-19.53l12.87 3.12c.78 1.5 1.939 2.78 3.359 3.69v12.72zm5.19-16.82c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm3.72-12.87c-1.14-.48-2.399-.75-3.72-.75s-2.58.27-3.72.75c-.14-.08-.31-.13-.49-.13h-15.27c3.41-7.35 10.86-12.46 19.48-12.46s16.07 5.11 19.48 12.46h-15.27c-.18 0-.35.05-.49.13zm1.47 29.69v-12.72c1.42-.91 2.579-2.19 3.359-3.69l12.87-3.12c-.559 9.47-7.299 17.31-16.229 19.53z"
                    fill="currentColor"
                  />
                </svg>
              </span>
...
.mg-hero__container {
  ...
  padding-left:
    var(--mg-page-gutter, 5vw) !important;
  padding-right:
    var(--mg-page-gutter, 5vw) !important;
